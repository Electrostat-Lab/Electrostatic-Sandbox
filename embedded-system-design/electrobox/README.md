...
An electronic monstrosity featuring the most prominent features of the Electrostatic-Sandbox Framework, a WIP SDK suite written purely in GNU/C99 with JNI bindings, and RTI based on the IEEE-1516 HLA and NASA DSES.
